...
(def source-trendline
  {:type "LineToolTrendLine"
   ...
   :points [{:time_t 1519223400, :offset 0, :price 39.23544835868695}
            {:time_t 1521725400, :offset 0, :price 35.88060448358687}]})
...
(def source-gann
  {:type "LineToolGannComplex"
   ...
   :points [{:time_t 1511879400, :offset 0, :price 1517.5723703553008}
            {:time_t 1515076200, :offset 0, :price 1794.9665041530848}]})
...
(comment
  ...
  (->> (assoc empty-meta
              ...
              :chart 888
              :content {:charts
                        [{:panes [{:sources [source-mainseries
                                             source-study

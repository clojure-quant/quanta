...
;(def window-10d (trailing-window :us1 :day 10 (to-est "2024-02-11T08:00:00")))
(def window-10d (trailing-window :us1 :day 10 (to-est "2024-02-10T18:00:00"))) ; TODO: BUG - takes the current date (even its not a trading day)
(def next-10 (take 10 (calendar-seq :us1 :m)))

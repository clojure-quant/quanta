...
(def tv-options-default 
  {:debug true ; false
   ...
   :widgetbar {:details true
               ...
               :news true
               :datawindow true
               :watchlist_settings {:default_symbols ["NYSE:AA" "NYSE:AAL" "NASDAQ:AAPL"]
                                    :readonly false}}
   ...
   "hide_legend" true
   "side_toolbar_in_fullscreen_mode" "on" ;offThis enables Drawings Toolbar Draw in fullscreen
   ...
   "create_volume_indicator_by_default"  "on" ; create_volume_indicator_by_default_once on
